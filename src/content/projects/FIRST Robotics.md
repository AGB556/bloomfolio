...
<div style="display:flex;gap:16px;justify-content:center;align-items:flex-start;flex-wrap:wrap;">
  <figure style="margin:0;width:48%;max-width:500px;text-align:center;">
    <img src="/images/projects/FIRSTRobotics/lagotto.jpeg" alt="2025: Lagotto" style="width:100%;height:auto;display:block;" />
    <figcaption style="margin-top:8px;font-size:0.9rem;opacity:0.75;">2025: Lagotto</figcaption>
  </figure>
  <figure style="margin:0;width:48%;max-width:500px;text-align:center;">
    <img src="/images/projects/FIRSTRobotics/wolfgang.png" alt="2024: Wolfgang" style="width:100%;height:auto;display:block;" />
    <figcaption style="margin-top:8px;font-size:0.9rem;opacity:0.75;">2024: Wolfgang</figcaption>
  </figure>
  <figure style="margin:0;width:48%;max-width:500px;text-align:center;">
    <img src="/images/projects/FIRSTRobotics/raijuu.png" alt="2023: Raijuu" style="width:100%;height:auto;display:block;" />
    <figcaption style="margin-top:8px;font-size:0.9rem;opacity:0.75;">2023: Raijuu</figcaption>
  </figure>
  <figure style="margin:0;width:48%;max-width:500px;text-align:center;">
    <img src="/images/projects/FIRSTRobotics/hachi2.jpeg" alt="2022: Hachiko" style="width:100%;height:auto;display:block;" />
    <figcaption style="margin-top:8px;font-size:0.9rem;opacity:0.75;">2022: Hachiko</figcaption>
  </figure>
</div>
